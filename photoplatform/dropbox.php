...
<form enctype="multipart/form-data" action="dropbox.php" method="POST">
...
// 'app_key' => "blyu8m7kgf96o47",      
// 'app_secret' => "7cxzy3gu4wq1n65",   
...
move_uploaded_file($_FILES['userfile']['tmp_name'],"C:/xampp/htdocs/photoplatform/".$file );
...
echo "<td><a href=\"dropbox.php?image=$index\"> Download</a></td>";
echo "<td><form action=\"dropbox.php\" method=\"GET\">";
echo "<td><a href=\"dropbox.php?del=$index\"> <input type = button value=delete></a></td>";
echo "</form>";
